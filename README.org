...
I do not use =org-roam=, =org-brain=, or any other package involving the bespoke Zettlekasten note taking method. My brain is simple. I like outlines and only outlines. For me, anything beyond a simple outline results in diministed productivity. See below for links to other transclusion solutions.
