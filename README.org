This package is not ready yet. Privacy please, unless you want to help track down a few persistent bugs. 
...
- [ ] pick bindings for org-clones-map 
* Known Bugs
...
- [ ] After an edit, the overlay is not replaced
